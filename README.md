...
* **Optimization Model**: We then use PyMCDM to select between clusters based on number of facilities served, catchment population, network coverage, and improvements over road transportation.
